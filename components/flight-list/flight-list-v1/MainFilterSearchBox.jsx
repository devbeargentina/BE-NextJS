...
const MainFilterSearchBox = () => {
  ...
  const handleSearch = () => {
    debugger;
     Router.push(`/flight-list-v1/${destinationLocationCode}/${destinationLocationName}/${originLocationCode}/${originLocationName}/${startDate}/${endDate}/s${adult}-${child}-${infant}`)
  }
  return (
    <>
